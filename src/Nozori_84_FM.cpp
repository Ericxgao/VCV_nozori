...
*/
	void process(const ProcessArgs& args) override {
        ...
        if (reduce_data_speed_index == 0) {
            FM_loop_(); // process data loop only at 1/4 the sampling rate in order to be more accurate with the hardware timing
...
struct Nozori_84_FMWidget : ModuleWidget {
	...
	Nozori_84_FMWidget(Nozori_84_FM* module) {
		...
		panelStandard->setBackground(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_FM.svg")));
		panelStandard->show();
		addChild(panelStandard);

		panelDark = new SvgPanel();
		panelDark->box.size = box.size;
		panelDark->setBackground(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_FM_dark.svg")));
		panelDark->hide();
		addChild(panelDark);
		...
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 30.3)), module, Nozori_84_FM::POT2_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 30.3)), module, Nozori_84_FM::POT1_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 52.8)), module, Nozori_84_FM::POT3_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 52.8)), module, Nozori_84_FM::POT4_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 75.1)), module, Nozori_84_FM::POT5_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 75.1)), module, Nozori_84_FM::POT6_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 97.5)), module, Nozori_84_FM::POT7_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 97.5)), module, Nozori_84_FM::POT8_PARAM));
	...
	void appendContextMenu(Menu* menu) override {
		Nozori_84_FM* module = dynamic_cast<Nozori_84_FM*>(this->module);
		assert(module);
