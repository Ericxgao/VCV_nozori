...
struct Nozori_84_SIN_WS : Module {
	enum ParamIds {
		POT2_PARAM,
		POT1_PARAM,
		POT3_PARAM,
...
*/
	void process(const ProcessArgs& args) override {
        ...
        if (reduce_data_speed_index == 0) {
            SIN_WS_loop_(); // process data loop only at 1/4 the sampling rate in order to be more accurate with the hardware timing
...
struct Nozori_84_SIN_WSWidget : ModuleWidget {
	...
	Nozori_84_SIN_WSWidget(Nozori_84_SIN_WS* module) {
		...
		panelStandard->setBackground(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_SIN_WS.svg")));
		panelStandard->show();
		addChild(panelStandard);

		panelDark = new SvgPanel();
		panelDark->box.size = box.size;
		panelDark->setBackground(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_SIN_WS_dark.svg")));
		panelDark->hide();
		addChild(panelDark);
		...
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 30.3)), module, Nozori_84_SIN_WS::POT2_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 30.3)), module, Nozori_84_SIN_WS::POT1_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 52.8)), module, Nozori_84_SIN_WS::POT3_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 52.8)), module, Nozori_84_SIN_WS::POT4_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 75.1)), module, Nozori_84_SIN_WS::POT5_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 75.1)), module, Nozori_84_SIN_WS::POT6_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 97.5)), module, Nozori_84_SIN_WS::POT7_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 97.5)), module, Nozori_84_SIN_WS::POT8_PARAM));

		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(11.9, 113.3)), module, Nozori_84_SIN_WS::IN1_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(24.4, 113.3)), module, Nozori_84_SIN_WS::IN2_INPUT));

		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(49.3, 113.3)), module, Nozori_84_SIN_WS::OUT2_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(36.8, 113.3)), module, Nozori_84_SIN_WS::OUT1_OUTPUT));

		addChild(createLightCentered<MediumLight<YellowLight>>(mm2px(Vec(58.3, 41.5)), module, Nozori_84_SIN_WS::LED4_LIGHT));
	...
	void appendContextMenu(Menu* menu) override {
		Nozori_84_SIN_WS* module = dynamic_cast<Nozori_84_SIN_WS*>(this->module);
		assert(module);
...
Model* modelNozori_84_SIN_WS = createModel<Nozori_84_SIN_WS, Nozori_84_SIN_WSWidget>("Nozori_84_SIN_WS");
