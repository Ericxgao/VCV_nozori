...
struct Nozori_84_SIN_PM : Module {
	enum ParamIds {
		POT2_PARAM,
		POT1_PARAM,
		POT3_PARAM,
...
struct Nozori_84_SIN_PMWidget : ModuleWidget {
	SvgPanel *panelStandard;
	SvgPanel *panelDark;
	Nozori_84_SIN_PMWidget(Nozori_84_SIN_PM* module) {
		setModule(module);

		box.size = Vec(12 * RACK_GRID_WIDTH, RACK_GRID_HEIGHT);
		panelStandard = new SvgPanel();
		panelStandard->box.size = box.size;
		panelStandard->setBackground(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_SIN_PM.svg")));
		panelStandard->show();
		addChild(panelStandard);

		panelDark = new SvgPanel();
		panelDark->box.size = box.size;
		panelDark->setBackground(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_SIN_PM_dark.svg")));
		panelDark->hide();
		addChild(panelDark);
		...
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 30.3)), module, Nozori_84_SIN_PM::POT2_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 30.3)), module, Nozori_84_SIN_PM::POT1_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 52.8)), module, Nozori_84_SIN_PM::POT3_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 52.8)), module, Nozori_84_SIN_PM::POT4_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 75.1)), module, Nozori_84_SIN_PM::POT5_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 75.1)), module, Nozori_84_SIN_PM::POT6_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(15.1, 97.5)), module, Nozori_84_SIN_PM::POT7_PARAM));
		addParam(createParamCentered<NozoriKnob>(mm2px(Vec(46.1, 97.5)), module, Nozori_84_SIN_PM::POT8_PARAM));

		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(11.9, 113.3)), module, Nozori_84_SIN_PM::IN1_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(24.4, 113.3)), module, Nozori_84_SIN_PM::IN2_INPUT));

		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(49.3, 113.3)), module, Nozori_84_SIN_PM::OUT2_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(36.8, 113.3)), module, Nozori_84_SIN_PM::OUT1_OUTPUT));

		addChild(createLightCentered<MediumLight<YellowLight>>(mm2px(Vec(58.3, 41.5)), module, Nozori_84_SIN_PM::LED4_LIGHT));
		addChild(createLightCentered<MediumLight<YellowLight>>(mm2px(Vec(2.9, 41.5)), module, Nozori_84_SIN_PM::LED2_LIGHT));

		addParam(createParamCentered<NKK>(mm2px(Vec(30.6, 14.3)), module, Nozori_84_SIN_PM::SWITCH_PARAM));
	...
	void appendContextMenu(Menu* menu) override {
		Nozori_84_SIN_PM* module = dynamic_cast<Nozori_84_SIN_PM*>(this->module);
		assert(module);
...
Model* modelNozori_84_SIN_PM = createModel<Nozori_84_SIN_PM, Nozori_84_SIN_PMWidget>("Nozori_84_SIN_PM");
